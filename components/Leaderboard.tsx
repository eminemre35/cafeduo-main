...
export const Leaderboard: React.FC = () => {
  ...
  // Wrapped in useCallback so the useEffect below can include it in its deps
  // without re-running on every render (it would, since arrow functions are a
  // new reference each render). filterType + selectedDepartment changes still
  // trigger a fresh fetch because they are dependencies of the callback.
