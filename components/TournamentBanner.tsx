...
export const TournamentBanner: React.FC<TournamentBannerProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 px-4 py-3 sm:px-6 sm:py-4 mt-1.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h3 className="font-riso-display text-base sm:text-lg text-carbon truncate">
            {tournament.name}
          </h3>
          <p
        ...
        <button
          ...
          className="riso-focus inline-flex items-center gap-1.5 border-2 border-carbon bg-paper px-3 py-2 font-riso-display text-xs sm:text-sm font-bold uppercase tracking-wider text-carbon hover:bg-riso-pink hover:text-paper transition-colors"
        >
          Sıralama <ArrowRight size={14} strokeWidth={2.5} />
        </button>
      </div>
    </div>
  );
