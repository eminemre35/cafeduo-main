    ...
    <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
      <div className="grid gap-10 md:grid-cols-12 md:items-center md:gap-12">
        ...
        <div className="md:col-span-7">
          ...
          >
            Öğrenci kafeleri için <em className="not-italic text-riso-pink-deep">sessiz</em> bir{' '}
          ...
          >
            Müşterileriniz masada mini oyunlar oynar, puan biriktirir, sizin koyduğunuz ödüllerle
            (kahve, indirim, tatlı) geri gelir. Kurulum 30 dakika. İlk ay ücretsiz. Sözleşme yok.
          </motion.p>
        ...
        >
          <div className="border-2 border-carbon bg-riso-mustard p-6 sm:p-7 riso-shadow-md">
            ...
            <p className="mt-2 font-riso-body text-sm leading-relaxed text-carbon">
              Setup&apos;ı birlikte yapıyoruz. Ay sonu 20 dakika geri bildirim + isim kullanım izni
              — o kadar.
            </p>
...
const NumbersBar: React.FC = () => (
  <section aria-label="Anahtar sayılar" className="border-t border-carbon/15 bg-paper">
    ...
    >
      {NUMBERS.map((n) => (
        <RevealItem key={n.label} className="flex items-center gap-4 px-2 py-6 sm:px-6">
...
const HowItWorksOwner: React.FC = () => (
  ...
  >
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      ...
      <RevealGroup className="grid grid-cols-1 gap-x-12 gap-y-10 md:grid-cols-3">
        {STEPS.map((s) => (
...
const ValueProps: React.FC = () => (
  <section aria-label="Faydalar" className="border-t border-carbon/15 bg-paper py-20 sm:py-28">
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      ...
      <RevealGroup className="grid grid-cols-1 gap-x-12 gap-y-10 md:grid-cols-2" stagger={0.06}>
        {BENEFITS.map((b) => (
...
const PricingSection: React.FC = () => (
  <section aria-label="Fiyatlandırma" className="border-t border-carbon/15 bg-paper py-20 sm:py-28">
    <div className="mx-auto max-w-3xl px-4 sm:px-6">
      ...
      <Reveal as="div" className="border-2 border-carbon bg-paper p-7 riso-shadow-md sm:p-9">
...
const FaqSection: React.FC = () => (
  ...
  >
    <div className="mx-auto max-w-3xl px-4 sm:px-6">
      <Reveal as="header" className="mb-10 text-left">
        <p className="font-riso-mono text-xs uppercase tracking-[0.18em] text-carbon-soft">
          Sık sorulanlar
        </p>
        <h2 className="mt-3 font-riso-display text-[2rem] leading-tight tracking-tight text-carbon sm:text-[2.6rem]">
...
const ClosingCta: React.FC = () => (
  <section aria-label="Son çağrı" className="relative bg-carbon py-20 text-paper sm:py-28">
    <div className="mx-auto max-w-4xl px-4 sm:px-6">
      <RevealGroup className="grid gap-8 md:grid-cols-12 md:items-end" stagger={0.1}>
        <RevealItem className="md:col-span-7">
          ...
          <p className="mt-4 max-w-xl font-riso-body text-[15px] leading-relaxed text-paper/85">
            ...
            Setup&apos;ı birlikte yapıyoruz, sizden 0 vakit.
          </p>
        </RevealItem>

        <RevealItem className="flex flex-col gap-3 md:col-span-5">
          <a
            href={whatsappHref}
            target="_blank"
            rel="noopener noreferrer"
