...
git log -p --all -S 'JWT_SECRET=' --no-textconv
git log -p --all -S 'DATABASE_URL=' --no-textconv
git log -p --all -S 'GOOGLE_CLIENT_SECRET=' --no-textconv
```
...
- [`backend/server.js:317`](backend/server.js:317) - `JWT_SECRET` from env
- [`backend/middleware/auth.js:7`](backend/middleware/auth.js:7) - `JWT_SECRET` from env
- [`backend/middleware/socketAuth.js:23`](backend/middleware/socketAuth.js:23) - `JWT_SECRET` from env
- [`backend/controllers/authController.js:11`](backend/controllers/authController.js:11) - `JWT_SECRET`, `GOOGLE_CLIENT_ID` from env
- [`backend/db.js:30`](backend/db.js:30) - `DATABASE_URL` from env
...
|------------|-------------------|-------------------|
| `JWT_SECRET` | GitHub Secrets (`DEPLOY_ENV_B64`) | Every 90 days (policy) |
| `DATABASE_URL` password | GitHub Secrets (`DEPLOY_ENV_B64`) | Every 90 days (policy) |
| `GOOGLE_CLIENT_SECRET` | GitHub Secrets (`DEPLOY_ENV_B64`) | Per Google policy |
| `RECAPTCHA_SECRET_KEY` | GitHub Secrets (`DEPLOY_ENV_B64`) | Per Google policy |
...
if git diff --cached | grep -qE 'JWT_SECRET=|DATABASE_URL=|GOOGLE_CLIENT_SECRET=|SMTP_PASS='; then
...
- [ ] New `JWT_SECRET` generated with: `openssl rand -hex 64`
